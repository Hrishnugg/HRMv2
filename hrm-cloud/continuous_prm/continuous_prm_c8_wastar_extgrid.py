...
# Canonical eval order (MUST match the WA* baseline / C8Config.eval_suites so
# suite_idx-derived world seeds reproduce the frozen cohorts; a prior version
# used an alphabetical list and evaluated a sibling cohort -- disclosed erratum).
