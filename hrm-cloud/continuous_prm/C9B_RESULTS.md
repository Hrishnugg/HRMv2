...
**Experiment:** `continuous_prm_c9b_dynamics_transfer.py` (spec: `../../docs/superpowers/specs/2026-06-30-c9b-dynamics-transfer-design.md`, plan: `../../docs/superpowers/plans/2026-06-30-c9b-dynamics-transfer.md`)
...
Related: [`C8_RESULTS.md`](C8_RESULTS.md) (the spotlight negative this re-tests), [`C9_RESULTS.md`](C9_RESULTS.md) / [`C9H_RESULTS.md`](C9H_RESULTS.md) (the static crossover this compares against), [`CONTINUOUS_PRM_STORY.md`](CONTINUOUS_PRM_STORY.md).
