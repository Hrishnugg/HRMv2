...
class DiagnosticConfig:
    ...
    out_dir: str = "runs/c13_lhbl_focal_integration_diagnostic"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="C13-H FOCAL integration diagnostic")
...
def main() -> None:
    ...
    manifest_path = C13.write_json(
        ...
        {
            "experiment": "C13-H FOCAL integration diagnostic",
            "config": asdict(cfg),
