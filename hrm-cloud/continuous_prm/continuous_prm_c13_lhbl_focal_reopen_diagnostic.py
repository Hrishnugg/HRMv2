...
class DiagnosticConfig:
    ...
    out_dir: str = "runs/c13_lhbl_focal_reopen_diagnostic"
...
def run_diagnostic(
    ...
    for density in sorted(bundles):
        for bundle in bundles[density]:
            ...
            baseline = focal_search_with_path(
                roadmap.adj,
                euclid,
                euclid,
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="C13-H reopening FOCAL diagnostic")
...
def main() -> None:
    ...
    manifest_path = C13.write_json(
        ...
        {
            "experiment": "C13-H bound-safe reopening FOCAL diagnostic",
            "config": asdict(cfg),
