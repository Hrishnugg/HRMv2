...
**Companions:** [`EXPERIMENT_RESULTS_COMPENDIUM.md`](../discrete/learned-heuristic/results/EXPERIMENT_RESULTS_COMPENDIUM.md) (discrete record) · [`EXPERIMENT_RESULTS_FOCAL_REDESIGN.md`](../discrete/learned-heuristic/results/EXPERIMENT_RESULTS_FOCAL_REDESIGN.md) · [`CONTINUOUS_PRM_STORY.md`](../continuous/program/CONTINUOUS_PRM_STORY.md) (continuous record) · [`CONTINUOUS_PRM_STRATEGY.md`](../continuous/program/CONTINUOUS_PRM_STRATEGY.md) (post-C9b step-back this audit refines).
