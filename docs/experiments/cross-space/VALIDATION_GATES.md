...
- Companion docs: `docs/experiments/discrete/direct-solver/audits/PORT_FIDELITY_AUDIT.md` (+ status block), `docs/experiments/discrete/direct-solver/results/RETRAIN_RESULTS.md`, `docs/experiments/cross-space/PROGRAM_AUDIT_HIERARCHY_AND_SUBSTRATE.md`.
