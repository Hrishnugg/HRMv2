...
*(corrected reference cohort 2026-07-27: the original probe's procedural
reference sample used the alphabetical suite-index defect and drew sibling
worlds; re-run on the canonical confirmation-cohort prefix — values shifted
marginally, structure unchanged; original in probe_voided_sibling_reference.json)*

| Set | r (median) | IQR | MAE | bias |
|---|---|---|---|---|
| Spiral (trained) | 0.977 | [0.963, 0.984] | 0.25 | −0.11 |
| Rooms (trained) | 0.954 | [0.929, 0.965] | 0.14 | −0.03 |
| Maze (trained) | 0.948 | [0.938, 0.962] | 0.20 | −0.07 |
| Dense maze (held-out param shift) | 0.936 | [0.917, 0.945] | 0.33 | −0.24 |
| Crossing (held-out topology) | 0.763 | [0.666, 0.797] | 0.35 | +0.34 |
| Large rooms (held-out scale shift) | 0.728 | [0.654, 0.757] | 0.28 | +0.19 |
