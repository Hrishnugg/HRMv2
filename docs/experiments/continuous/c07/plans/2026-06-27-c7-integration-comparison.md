...
**Spec:** `docs/experiments/continuous/c07/design/2026-06-27-c7-integration-comparison-design.md`
...
| `docs/experiments/continuous/c07/results/C7_RESULTS.md` | **New** | Publication-grade writeup (Task 13). |
...
**Files:**
- Create: `docs/experiments/continuous/c07/results/C7_RESULTS.md`
...
```bash
git add docs/experiments/continuous/c07/results/C7_RESULTS.md
