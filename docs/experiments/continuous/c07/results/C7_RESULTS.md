...
**Experiment:** `continuous_prm_c7_integration_compare.py` (spec: [`2026-06-27-c7-integration-comparison-design.md`](../design/2026-06-27-c7-integration-comparison-design.md), plan: [`2026-06-27-c7-integration-comparison.md`](../plans/2026-06-27-c7-integration-comparison.md))
...
Related: [`C8_RESULTS.md`](../../c08/results/C8_RESULTS.md) (dynamics — this extended into space-time), [`C9_RESULTS.md`](../../c09/results/C9_RESULTS.md) (few-shot transfer — adapts this run's `avgbase`), [`C6_RESULTS.md`](../../c06/results/C6_RESULTS.md) (value-field stage this builds on), [`EXPERIMENT_RESULTS_FOCAL_REDESIGN.md`](../../../discrete/learned-heuristic/results/EXPERIMENT_RESULTS_FOCAL_REDESIGN.md) (discrete focal search), [`EXPERIMENT_RESULTS_COMPENDIUM.md`](../../../discrete/learned-heuristic/results/EXPERIMENT_RESULTS_COMPENDIUM.md) (program history).
...
- **Discrete grid (Manhattan baseline):** Manhattan is a *tight* admissible heuristic, so additive over-inflation pushed it inadmissible and *hurt*, while the focal band was narrow enough that the learned tie-break helped — focal won (see [`EXPERIMENT_RESULTS_FOCAL_REDESIGN.md`](../../../discrete/learned-heuristic/results/EXPERIMENT_RESULTS_FOCAL_REDESIGN.md)).
