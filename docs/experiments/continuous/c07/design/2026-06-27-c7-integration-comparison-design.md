...
Related docs:
- `docs/experiments/continuous/c06/results/C6_RESULTS.md` — value-field stage (the win this builds on).
- `docs/experiments/discrete/learned-heuristic/results/EXPERIMENT_RESULTS_FOCAL_REDESIGN.md` — discrete focal search (ranker integration).
- `docs/experiments/discrete/learned-heuristic/results/EXPERIMENT_RESULTS_COMPENDIUM.md` — full program history + methodology.
