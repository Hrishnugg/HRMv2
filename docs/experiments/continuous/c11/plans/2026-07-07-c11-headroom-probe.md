...
> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development. Probe-scale: 4 tasks. Design user-approved 2026-07-07 (inline); derived from `docs/experiments/cross-space/PROGRAM_AUDIT_HIERARCHY_AND_SUBSTRATE.md` §7.
