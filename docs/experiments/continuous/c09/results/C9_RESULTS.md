...
**Experiment:** `continuous_prm_c9_transfer.py` (spec: [`2026-06-29-c9-transfer-design.md`](../design/2026-06-29-c9-transfer-design.md), plan: [`2026-06-29-c9-transfer.md`](../plans/2026-06-29-c9-transfer.md))
...
Related: [`C9H_RESULTS.md`](../../c09h/results/C9H_RESULTS.md) (matched-compute + field hardening of this result), [`C10_RESULTS.md`](../../c10/results/C10_RESULTS.md) (zero-label parameter-space interpolation of these adapters — a clean null: interpolation can't pass the LoRA plateau), [`C7_RESULTS.md`](../../c07/results/C7_RESULTS.md) (static integration; source base), [`C8_RESULTS.md`](../../c08/results/C8_RESULTS.md) (dynamics), [`continuous_prm_experiment_ladder_repo_coupled.md`](../../c01-c04/continuous_prm_experiment_ladder_repo_coupled.md) (C1–C4 transfer lineage).
