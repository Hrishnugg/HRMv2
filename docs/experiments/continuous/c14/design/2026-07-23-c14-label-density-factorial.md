...
## 8. Amendment v3 (2026-07-25, post-completion — supersession of §5's no-edit clause)

§5 committed that the paper's submitted claims "will not be edited in response to it before review." That clause was written when C14 was expected to complete after the paper's submission; its purpose was to prevent outcome-driven revision of submitted claims. C14 instead completed **before** submission, and its verdict (H-C14 rejected; world diversity, not state count, governs the low-supervision failure) directly falsified the attribution in the paper's adaptation sentence. Two external reviews independently concluded that submitting a main paper whose own supplement refutes its abstract is worse for scientific integrity than a transparent revision. **On the author's explicit direction (2026-07-25), the clause is superseded:** the abstract's adaptation clause and the main paper's adaptation section are revised to report C14's finding, with minimal changes, and this amendment records the decision, its timing, and its reason. The K-indexed results themselves are unchanged; only their mechanism attribution is corrected to match the preregistered factorial's outcome.
