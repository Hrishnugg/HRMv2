...
**Derived from:** `hrm-cloud/PROGRAM_AUDIT_HIERARCHY_AND_SUBSTRATE.md` §7 (arms + gates) and the G0-H headroom probe (`hrm-cloud/continuous_prm/C11_HEADROOM.md`: **PASSED** — matched oracle/legsum ratios 0.082–0.225 across all 9 cells, monotone dose-response in K).
