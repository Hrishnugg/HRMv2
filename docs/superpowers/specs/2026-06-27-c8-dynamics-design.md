...
Related docs:
- `../../../hrm-cloud/continuous_prm/C7_RESULTS.md` + `2026-06-27-c7-integration-comparison-design.md` (the static integration comparison this extends).
- `../../../hrm-cloud/continuous_prm/C6_RESULTS.md` (value-field stage).
- `../../../hrm-cloud/EXPERIMENT_RESULTS_FOCAL_REDESIGN.md` (discrete space-time focal A\*ε — the dynamics reference).
